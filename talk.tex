...
\begin{frame}{Phenomenology of Anomalous \allbold{\klambda}}
  \begin{columns}[t]
    ...
    \ra signal acceptance also depends on \klambda
...
\begin{frame}{Constraining the Higgs Boson Self-Coupling}
  \begin{columns}[onlytextwidth]
    ...
    \item Signal process replaced by non-res.\ \HH production with arbitrary
      \klambda
    \end{itemize}
    ...
    Upper limits on $\sigma(pp \to HH)$ at 95\,\% CL
