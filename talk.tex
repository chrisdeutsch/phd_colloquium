  ...
  \begin{columns}
    ...
    \resizebox{\textwidth}{!}{%
      \begin{tabular}{lcc}
        ...
        \ttbar (fake \tauhadvis) & \allbold{\textcolor{topfakered}{Simulation + scale factors}} & \multirow{2}{*}{\textcolor{fakeblue}{Fake factor method}} \\[0.1em]
    ...
    \begin{overpic}[width=\textwidth]{mhh_hadhad}
      \put(56,94){\tiny arXiv:2209.10910}
    \end{overpic}
  \end{columns}
...
\begin{frame}{Background Estimation: Multi-Jet (Fake Factor Method)}
  \begin{columns}[onlytextwidth]
    ...
    Define multi-jet-enriched CRs using:
    \begin{itemize}
    ...
    \onslide<2->{%
      \begin{itemize}
      \item FFs binned in \tauhadvis properties (\pT, \Ntracks, $\eta$), trigger
        category (STT/DTT), year of data-taking.
