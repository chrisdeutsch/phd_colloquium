...
\begin{frame}{Summary \& Outlook}
  ...
  \item This search is the most sensitive to \allbold{SM \HH production} to date:
    \begin{itemize}
    \item $\mu_{HH} < 4.7$ (obs.) and $\mu_{HH} < 3.9$ (exp.) at 95\,\% CL
    \end{itemize}

  \item Provides stringent contraints for \allbold{resonant \HH production} with
    $\SI{375}{\GeV} \leq \mX \leq \SI{800}{\GeV}$

  \item \allbold{anomalous \klambda}
  ...
  \item Re-analysis with additional optimisations to be published
