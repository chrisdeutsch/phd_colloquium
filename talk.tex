  ...
  \begin{frame}<article:0>[plain]
    ...
    \begin{tikzpicture}[remember picture,overlay,shift=(current page.south
      ...
      \node[align=center] at (0.21,0.27){%
        \fcolorbox{headergray}{white}{\includegraphics[width=0.42\textwidth]{higgs_discovery/fig_009}}
      };
...
\begin{frame}{The Higgs Boson Self-Coupling}
  \begin{center}
    \begin{tabular}{ccccccc}
      $V(H)$ & $=$ & ${\color{Red} \lambda v^2 H^2}$ & $+$ & ${\color{Blue} \lambda v H^3}$ & $+$ & ${\color{Green} \frac{\lambda}{4} H^4}$ \\[1.2em]
             && \onslide<2->{\raisebox{1.85em}{\includegraphics[scale=1.0]{feynman_graphs_talk/higgs_massterm}}}
             && \onslide<3->{\includegraphics[scale=1.0]{feynman_graphs_talk/higgs_hhh}}
             && \onslide<4->{\includegraphics[scale=1.0]{feynman_graphs_talk/higgs_hhhh}} \\[1.2em]
  ...
  %       \fcolorbox{headergray}{white}{\includegraphics[width=0.5\textwidth]{higgs_potential_variation}}
  %     };
...
\begin{frame}{Tau Identification:\ Performance}
  ...
  \begin{columns}[onlytextwidth]
    ...
    \begin{overpic}[width=0.97\textwidth]{tauid/roc_incl_witherrors}
    ...
    \item<3-> Default identification algorithm for analyses of the Run~2 dataset

    \item<3-> Adopted for use in the high-level trigger (end of Run~2 \& Run~3)
...
\begin{frame}{Event Selection}
  ...
  \onslide<1>{
    \begin{tikzpicture}[remember picture,overlay,shift=(current page.south
      west),x=(current page.south east),y=(current page.north west)]
      \filldraw[white](0.1,0.1) rectangle (0.9,0.45);
    \end{tikzpicture}
  }
  \onslide<2>{}
  ...
  \begin{columns}[onlytextwidth]
    ...
    \onslide<2->{%
      \begin{overpic}[width=0.45\textwidth]{pnn_sketch}
        \put(85,25){\footnotesize \parbox[t]{0.43\textwidth}{Solves
...
\begin{frame}{Search for Resonant \allbold{\HH} Production: Discovery Tests}
  ...
  \begin{columns}[onlytextwidth, b]
    ...
    \onslide<2->{%
      \hspace*{0.14\textwidth}\includegraphics[width=0.75\textwidth, trim=0 0.3em 0 1em,
...
\begin{frame}{Summary \& Outlook}
  ...
  \item Re-analysis with additional optimisations in progress -- stay tuned!

  \item First evidence of SM HH production ($Z_0 > 3\sigma$) expected with the
    HL-LHC dataset
