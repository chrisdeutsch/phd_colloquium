...
\begin{frame}{Background Estimation: \allbold{$Z + \text{jets}$}}
  ...
  %   \includegraphics[width=0.8\textwidth]{zhfcr/Region_BMin0_incJet1_Y2015_DZllbbCR_T2_L2_distmLL_J2_Prefit_fixed}

  %   \column{0.5\textwidth}
  %   \centering

  %   \begin{overpic}[width=0.8\textwidth]{zhfcr/Region_BMin0_incJet1_Y2015_DZllbbCR_T2_L2_distmLL_J2_GlobalFit_conditionnal_mu0_fixed}
  %     \put(16.5,71.5){\footnotesize Z+HF SF $\approx 1.4$}
  %   \end{overpic}
  % \end{columns}
\end{frame}
...
\begin{frame}{Background Estimation: \allbold{\ttbar} with Fake \allbold{\tauhadvis}}
  \begin{columns}[onlytextwidth]
