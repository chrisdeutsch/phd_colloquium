...
\begin{frame}{Statistical Analysis}
  ...
  \begin{center}
    \includegraphics[width=0.4\textwidth, trim=0.5em 0.5em 2em 1.5em,
    clip]{mva/prefit/Region_BMin0_incJet1_distSMBDT_J2_Y2015_DLLOS_T2_SpcTauHH_L0_Prefitlog_removedratio}
  \end{center}

  % \begin{itemize}

  % \item Statistical model based on binned distributions of discriminants in
  %   all regions
