...
\begin{frame}{Tau Identification:\ Inputs}
  ...
  \end{minipage}%
  \begin{minipage}[c][2cm][c]{0.75\textwidth}
    ABC
  \end{minipage}%
  ...
  \end{minipage}%
  \begin{minipage}[c][2cm][c]{0.75\textwidth}
    Up to 10 tracks within $\dR < 0.4$ of tau axis
  \end{minipage}%
  ...
  \end{minipage}%
  \begin{minipage}[c][2cm][c]{0.75\textwidth}
    Up to 6 clusters associated to the jet seed.
  \end{minipage}
\end{frame}
...
\begin{frame}{Tau Identification:\ Network Architecture}
  ...
  \begin{center}
    \includegraphics[width=0.9\textwidth]{tauid/rnn_approach}
  \end{center}
\end{frame}
