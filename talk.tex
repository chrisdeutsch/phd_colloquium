...
\begin{frame}{Electroweak Symmetry Breaking}
  \begin{center}
    \begin{tikzpicture}
      ...
      \onslide<3->{
        ...
        \draw[stealth-stealth, line width=1pt, color=myblue] %
  ...
  \textbf{Perturbation theory:} Have to consider perturbations about the vacuum state
  \begin{itemize}
  \item Radial perturbations $v + H(x, t)$ -- physical Higgs boson
