...
\begin{frame}{The \bbtautau Final State}
  \begin{columns}[onlytextwidth]
    ...
    \includegraphics<1>[width=\textwidth]{final_state/final_state_lephad}%
    \includegraphics<2>[width=\textwidth]{final_state/final_state_hadhad}
...
% \vspace*{1em}
    ...
    % \begin{itemize}
    % \item $HH \to \bbtautau$
    % \item Targeting semi-leptonic (\lephad) and fully hadronic (\hadhad) di-tau
    %   final states
    % \end{itemize}
