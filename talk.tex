...
\begin{frame}{Nuisance Parameter Pull/Impact Plots:\ Combined Fit}
  ...
  \includegraphics[width=0.4\textwidth]{results_nonres/rankings/ranking_nonres_combined}
\end{frame}
...
\begin{frame}{Nuisance Parameter Pull/Impact Plots:\ \allbold{\hadhad}/\allbold{\lephad}-Only}
  ...
  \includegraphics[width=0.4\textwidth]{results_nonres/rankings/ranking_nonres_hadhad}\hspace*{3em}
  \includegraphics[width=0.4\textwidth]{results_nonres/rankings/ranking_nonres_lephad}
\end{frame}
