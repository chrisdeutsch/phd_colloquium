...
\begin{frame}{Approach}
  \textbf{Previous method based on Boosted Decision Trees:}\\[0.5em]
  \begin{center}
    \includegraphics[scale=0.68]{tauid/bdt_approach}
  \end{center}
  ...
  \begin{center}
    \includegraphics[scale=0.68]{tauid/rnn_approach}
  \end{center}
\end{frame}
...
\begin{frame}{Signal Extraction: resonant}
  \begin{columns}
    ...
    Classification task changes with \mX \ra PNN
...
\begin{frame}{Constraining the Higgs Boson Self-Coupling}
  ...
  \item Reinterpretation is performed
  \end{itemize}
\end{frame}
